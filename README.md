...
| Gateway can't access workspace | Multi-container gateway missing `/workspace` mount, using host path, or starting outside the workspace | Recreate with current compose; inside containers use `/workspace` |
